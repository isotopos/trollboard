...
(function() {
    ...
    'chaplin/dispatcher': function(exports, require, module) {
      ...
      return module.exports = Dispatcher = (function() {
        ...
        Dispatcher.prototype.adjustURL = function(controller, params) {
          ...
          if (params.changeURL) this.publishEvent('!router:changeURL', url);
          return this.url = url;
        };
    ...
    'chaplin/views/layout': function(exports, require, module) {
      ...
      return module.exports = Layout = (function() {
        ...
        Layout.prototype.initialize = function(options) {
          ...
          if (this.settings.routeLinks) this.startLinkRouting();
        ...
        Layout.prototype.openLink = function(event) {
          var $el, el, href, internal, isAnchor, path, skipRouting, type, _ref, _ref2;
    ...
    'chaplin/views/collection_view': function(exports, require, module) {
      ...
      return module.exports = CollectionView = (function(_super) {
        ...
        CollectionView.prototype.initialize = function(options) {
          ...
          if (options.renderItems != null) this.renderItems = options.renderItems;
          if (options.itemView != null) this.itemView = options.itemView;
          if (options.filterer != null) return this.filter(options.filterer);
        };
        ...
        CollectionView.prototype.render = function() {
          ...
          if (this.renderItems) return this.renderAllItems();
        };
        ...
        CollectionView.prototype.filter = function(filterer, filterCallback) {
          ...
          if (filterCallback) this.filterCallback = filterCallback;
  ...
  require.define({
    'chaplin/lib/event_broker': function(exports, require, module) {
      ...
      if (typeof Object.freeze === "function") Object.freeze(EventBroker);
