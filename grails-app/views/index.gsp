...
<head>
  ...
  <link rel="stylesheet" href="css/fancybox/jquery.fancybox.css?v=2.0.6" type="text/css" media="screen" />
...
<body data-spy="scroll" data-target="#primary-nav">
  ...
  <script>window.jQuery || document.write('<script src="app/www/js/vendor/jquery-1.8.2.min.js"><\/script>')</script>
  <script src="app/www/js/vendor/bootstrap/2.1.1/js/bootstrap.min.js"></script>
  <script src="app/www/js/vendor/jquery.anchor.js" type="text/javascript"></script>
  <script src="app/www/js/vendor/script.js"></script>
  <script type="text/javascript" src="app/www/js/vendor/fancybox/jquery.fancybox.pack.js?v=2.0.6"></script>
