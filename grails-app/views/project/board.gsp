  ...
  <body>
    <div id="wrap">
      ...
      <div id="core" style="margin-top: -90px;">
        ...
        <a href="https://github.com/${ownerId}/${name}/issues/new" class="btn btn-danger" target="_blank" style="top: 40px;">New issue</a>
                      ...
                      <div style="position: relative;margin-left: 0px;"
                        ...
                        <div class="mojitoPanelHeader mojitoPanelHeader-dark" id="wRealtimeGraphDD">
                          <g:if test="${issue?.assignee}">
                            <div>
                              <img height="24" width="24" src="${issue.assignee.avatar}"
